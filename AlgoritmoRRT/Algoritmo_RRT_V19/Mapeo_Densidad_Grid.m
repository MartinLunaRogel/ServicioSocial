% Mapeo_Densidad_Grid.m
% =========================================================================
% === FUNCION AUXILIAR PARA MAPEO DE COORDENADAS A INDICES DE CELDA ===
%
% Descripción: Convierte coordenadas (x, y) a índices de celda (columna, fila)
% para ser usada en el mapa de densidad.
% =========================================================================

function [col_idx, row_idx] = Mapeo_Densidad_Grid(coord, x_limites, y_limites, grid_size)
