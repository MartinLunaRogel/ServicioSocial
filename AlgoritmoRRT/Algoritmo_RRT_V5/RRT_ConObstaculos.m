% Algoritmo RRT con un primer obstaculo (Obstaculo enforma de "C")
% Martin Luna Rogel
%
% Descripción:
...
%   Se añadio un obstaculo en forma de "C" invertida para tratar de que el arbol salga de este espacio, dejando somalente un poco de espacio a los alrededores por donde pasar)
%
% Entradas:
%   - Ninguna.
%
...
inicio = [10, 50];      % Es el punto de partida del algoritmo. Se usará para iniciar el "árbol" de búsqueda.
...
grid_size = 10;         % Tamaño de la celda de la cuadricula (10x10 unidades)
...
% =========================================================================
% === DEFINICIÓN DE OBSTÁCULOS EN UN CELL ARRAY ===
% =========================================================================

% Formato de cada celda: { [X_min, X_max], [Y_min, Y_max] }
obstaculos = {
    % Obstáculo 1: Barra Vertical
    [50, 51], [10, 90];

    % Obstáculo 2: Barra Horizontal Superior
    [10, 51], [89, 90];

    % Obstáculo 3: Barra Horizontal Inferior
    [10, 51], [10, 11]
};
