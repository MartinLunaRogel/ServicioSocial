...
% Nota importente de los argumentos: Se mantiene el cuarto argumento (que antes era distancia_muestreo) para no romper
% la compatibilidad con las llamadas desde otros archivos, pero ya no es necesario en esta version.
