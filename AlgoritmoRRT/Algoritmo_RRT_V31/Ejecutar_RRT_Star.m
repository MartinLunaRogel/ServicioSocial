...
% También cargamos el mapa discreto de una vez para las colisiones de Bresenham
disp('Cargando Grid Caching en memoria...');
mapa_discreto = load('Mapa_Discreto.txt');

disp('Generando semillas uniformes sobre las calles...');
distancia_malla = 50;

% ACTUALIZADO: Llamamos a la nueva función pasándole el esqueleto
semillas = Generar_Semillas_Malla(coordenadas_esqueleto, distancia_malla);
