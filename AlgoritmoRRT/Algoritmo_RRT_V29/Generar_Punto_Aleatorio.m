function rand_point = Generar_Punto_Aleatorio(other_nodes, current_density_map, x_limites, y_limites, grid_size, prob_objetivo, prob_bias, coordenadas_esqueleto)
    r_prob = rand;
    ...
    % 3. NUEVO: Muestreo sobre el Eje Medial (100% libre de colisiones estáticas)
    else
        % Elegimos una fila al azar de nuestra lista de coordenadas perfectas
