function Interfaz_RRT()
    ...
    function ejecutarRRT(~, ~)
        ...
        assignin('base', 'mapa_esqueleto', mapa_esqueleto);
        assignin('base', 'coordenadas_esqueleto', coordenadas_esqueleto);
        assignin('base', 'mapa_discreto', mapa_discreto);
        assignin('base', 'semillas', semillas);
    ...
    function reiniciarSistema(~, ~)
        ...
        % 2. Limpiar variables globales en la memoria RAM
        clear global obstaculos mapa_esqueleto coordenadas_esqueleto mapa_discreto semillas;
        global obstaculos mapa_esqueleto coordenadas_esqueleto mapa_discreto semillas;

        % 3. Limpiar visualmente el área del mapa
        cla(ax);
